...
<nav class="navbar navbar-light bg-light justify-content-between">
    <a class="navbar-brand" id="navbarBrand"> <tag:message code="adminusers.userupdate"/></a>
</nav>
<main>
    <div class="container">
        <p class="product-id"><tag:message code="userupdate.login"/> ${user.login}</p>
        <div class="loginform">
            <form:form method="POST" modelAttribute="userDataForm" class="form-user"
                       action="${pageContext.request.contextPath}/admin/update">
                <form:input type="hidden" id="login" path="login" value="${user.login}"/>
                <div class="form-gr">
                ...
                <div class="form-gr">
                    ...
                    <form:input type="name" id="name" path="name" value="${user.name}"/>
                    <form:errors path="name"/>
                </div>
                <div class="form-gr">
                    <p><tag:message code="userdata.surname"/></p>
                    <form:input type="surname" id="surname" path="surname" value="${user.surname}"/>
                    <form:errors path="surname"/>
                </div>
                <div class="form-gr">
                    <p><tag:message code="userdata.email"/></p>
                    <form:input type="email" id="email" path="email" value="${user.email}"/>
                    <form:errors path="email"/>
                </div>
                <div class="form-gr">
                    <p><tag:message code="userdata.phone"/></p>
                    <form:input type="phone" id="phone" path="phone" value="${user.phone}"/>
                    <form:errors path="phone"/>
                </div>
                <div class="form-gr">
                    <p><tag:message code="userdata.birthdate"/></p>
                    <form:input type="birthdate" id="birthdate" path="birthdate" value="${user.birthdate}"/>
                    <form:errors path="birthdate"/>
                </div>
                <div class="form-gr">
                    <p><tag:message code="userdata.address"/></p>
                    <form:input type="address" id="address" path="address" value="${user.address}"/>
