...
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('1', 'Album #2', 'infaboutalbum2','album1.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('2', 'Pen #30', 'infaboutpen33','pen30.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('3', 'Album #66', 'infaboutalbum66','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('4', 'Album #67', 'infaboutalbum67','album55.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('5', 'Album #68', 'infaboutalbum68','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('6', 'Album #32', 'infaboutalbum32','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('7', 'Album #71', 'infaboutalbum71','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('8', 'Album #72', 'infaboutalbum72','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('9', 'Album #73', 'infaboutalbum73','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('10', 'Album #74', 'infaboutalbum74','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('11', 'Album #75', 'infaboutalbum75','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('12', 'Album #76', 'infaboutalbum76','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('13', 'Album #77', 'infaboutalbum77','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('14', 'Album #78', 'infaboutalbum78','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('15', 'Album #79', 'infaboutalbum79','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('16', 'Album #80', 'infaboutalbum80','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('17', 'Album #81', 'infaboutalbum81','album66.jpg','1');
INSERT INTO `webdb`.`products` (`product_id`,`name`, `description`,`imageurl`,`catver_id`) VALUES ('18', 'Album #82', 'infaboutalbum82','album66.jpg','1');
